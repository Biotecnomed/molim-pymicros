...
#
# ARG_HELP([MOLIM PY-MICROS STARTUP SCRIPT])
# ARG_POSITIONAL_SINGLE([code],[Molim model code])
# ARG_POSITIONAL_SINGLE([port],[TCP port of the service])
# ARGBASH_GO()
...
print_help()
{
	printf '%s\n' "MOLIM PY-MICROS STARTUP SCRIPT"
	printf 'Usage: %s [-h|--help] <code> <port>\n' "$0"
	printf '\t%s\n' "<code>: Molim model code"
...
{
	local _required_args_string="'code' and 'port'"
...
assign_positional_args()
{
	...
	_positional_names="_arg_code _arg_port "
